...
function buildViewHref({
  ...
  return `/sponsor/reports/sales-by-sponsor-report?${params.toString()}`;
}
...
export default async function SalesBySponsorReportClient({ searchParams, sponsorId }: PageProps) {
  const { from, to, sponsor: sponsorParam, view } = await searchParams;
