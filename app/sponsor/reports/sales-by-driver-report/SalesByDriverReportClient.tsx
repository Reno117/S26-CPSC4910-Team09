...
function buildViewHref({
  ...
  return `/sponsor/reports/sales-by-driver-report?${params.toString()}`;
}
...
export default async function SalesByDriverReportClient({ searchParams, sponsorId }: PageProps) {
  const { from, to, sponsor: sponsorParam, view, driver = "" } = await searchParams;
