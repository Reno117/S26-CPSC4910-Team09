...
export default function SponsorSettingsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <SponsorHeader userSettings={{ name: "", email: "", role: "sponsor" }} />
            ...
            {!togglesLoaded ? (
              ...
              <div className="space-y-4">
                {[
                  ...
                  { key: "orderAlert", label: "Order Alerts", desc: "Receive alerts when drivers place new orders" },
                  { key: "applicationAlert", label: "Application Alerts", desc: "Receive alerts when drivers submit new applications" },
                ].map(({ key, label, desc }) => (
